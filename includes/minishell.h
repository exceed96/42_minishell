...
/*   Updated: 2022/09/11 18:18:38 by sangyeki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		**ft_fill_cmd_2(char **str, const char *in_cmd, char *set, int q[3]);
...
int			ft_wordscount(const char *in_cmd, char *set, int c[3]);
...
int			ft_split_fd(char **env, int new_line, int fd);
